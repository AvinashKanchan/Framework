...
public class CreatePurchaseOrderWithItemServicesUpwardSymbolTest extends BaseClass{
	
		@Test(groups = "regressionTest")
		public void createPurchaseOrderWithItemServicesUpwardSymbolTest() throws Throwable
		{
...
//		String poSubject=eLib.getExcelData("PurchaseOrderData", 1, 3)+ranNum;
		...
		cnpop.getItemUpwardArrowImage().click();
